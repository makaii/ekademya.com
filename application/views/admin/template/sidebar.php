		<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2 bg-faded sidebar-style-1">
			...
			<ul class="nav nav-pills flex-column sidebar-nav">
				...
				<li class="nav-item"><a class="nav-link <?php if(!empty($courses_active)){echo $courses_active;} ?>" href="<?php echo base_url("admin/courses"); ?>"><em class="fa fa-book"></em> Courses <span class="sr-only">(current)</span></a></li>
				<li class="nav-item"><a class="nav-link <?php if(!empty($course_review_active)){echo $course_review_active;} ?>" href="<?php echo base_url("admin/course_review"); ?>"><em class="fa fa-list"></em> Course Review</a></li>
				<li class="nav-item"><a class="nav-link <?php if(!empty($categories_active)){echo $categories_active;} ?>" href="<?php echo base_url("admin/categories"); ?>"><em class="fa fa-tags"></em> Categories</a></li>
