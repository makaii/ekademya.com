							...
							<?php foreach ($w as $outline => $o): ?>
								...
								<?php elseif($o['outline_type']=='video'): ?>
									<div class="form-group">
										...
										<p class="form-control-plaintext pb-0 mb-1 text-muted quote">
											<?php echo nl2br($o['video_description']); ?>
										</p>
										<?php if($o['video_thumbnail']==null){$thumbnail_url = "default_thumbnail.png";}else $thumbnail_url=$o['video_thumbnail']; ?>
										<video controls controlsList="nodownload" preload="none" poster="<?php echo base_url("z/thumbnails/$thumbnail_url"); ?>" width="480" height="270">
											<?php $ext=pathinfo($o['video_url'],PATHINFO_EXTENSION); ?>
											<?php if($ext=='mp4'): ?>
												<source src="<?php echo base_url("z/course/".$o['video_url']); ?>" type="video/mp4">
											<?php elseif($ext=='webm'): ?>
												<source src="<?php echo base_url("z/course/".$o['video_url']); ?>" type="video/webm">
											<?php endif; ?>
										</video>
								...
								<?php elseif($o['outline_type']=='lecture'): ?>
									<div class="form-group">
										<label class="font-weight-bold">Lecture Title : <span class="text-info"><?php echo $o['lecture_title']; ?></span></label>
										<p class="form-control-plaintext pb-0 mb-1 text-muted quote">
											<?php echo nl2br($o['lecture_body']); ?>
										</p>
										<input class="form-control form-control-sm" placeholder="comments" name="<?php echo "review_outline_$outline"; ?>" value="<?php echo set_value("review_outline_$outline",$review_outline[$outline]); ?>"></input>
										<?php echo form_error("review_outline_$outline"); ?>
										<hr>
