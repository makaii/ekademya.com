						...
						<div class="card-body">
							...
							<form id="videoForm" action="<?php echo base_url('course/edit/outline/'.$course_id.'/video_check'); ?>" method="POST" style="display: none;" enctype="multipart/form-data" accept-charset="utf-8">
								<div class="form-group">
									...
									<input class="form-control form-control-sm" id="INPUTsection" name="video_title" placeholder="Enter Video Title" maxlength="50"></input>
								</div>
								<div class="form-group">
									<textarea class="form-control form-control-sm" name="video_description" placeholder="Video Description" rows="4" maxlength="1000"></textarea>
								</div>
								<div class="form-group">
							...
							<form id="lectureForm" action="<?php echo base_url('course/edit/outline/'.$course_id.'/lecture_check'); ?>" method="POST" style="display: none;">
								<div class="form-group">
									...
									<input class="form-control form-control-sm" name="lecture_title" placeholder="Enter Lecture Title" maxlength="""></input>
								</div>
								<div class="form-group">
									<textarea class="form-control form-control-sm" name="lecture_body" placeholder="Lecture Body"  rows="4" maxlength=""></textarea>
								</div>
								<div class="form-group">
