...
<form action="<?php echo base_url("course/edit/outline/$course_id/week/$week_id/$week_code/video"); ?>" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
	<div class="container">
		<div class="row">
			<div class="col-md-7">
				<div class="card border-info">
					<div class="card-body">
						<div class="form-group">
							...
							<input class="form-control form-control-sm" id="INPUTsection" name="video_title" placeholder="Enter Video Title" maxlength="50" value="<?php echo set_value('video_title',null); ?>"></input>
							<?php echo form_error('video_title'); ?>
						</div>
						<div class="form-group">
							<textarea class="form-control form-control-sm" name="video_description" placeholder="Video Description" rows="6" maxlength="1000"><?php echo set_value('video_description',null); ?></textarea>
