						...
						<div class="col-md-4">
							<div class="card">
								<div class="card-body text-center">
									...
									<hr>
									<a rolse="button" class="btn btn-sm btn-block btn-info" href="<?php echo base_url("course/edit/outline/$course_id/video"); ?>">Add Video</a>
									<a rolse="button" class="btn btn-sm btn-block btn-info" href="<?php echo base_url("course/edit/outline/$course_id/lecture"); ?>">Add Lecture</a>
