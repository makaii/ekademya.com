	...
	<div class="row mt-4 mb-4">
		...
		<div class="col-md-8">
			<div class="card">
				...
				<div class="card-body" id="outlineButtons" style="display: none;">
					<div class="row">
						<div class="col-md-3">
					...
					<div class="col-md-12">
						<div class="card-body">
							...
							<form id="videoForm" action="<?php  ?>" method="POST" style="display: none;">
								...
								<div class="form-group">
									<textarea class="form-control" name="video_description" placeholder="Video Description" rows="4" maxlength="1000"><?php echo set_value('video_description'); ?></textarea>
							...
							<!-- Lecture Form -->
							<form id="lectureForm" action="<?php echo base_url('course/manage/outline/'.$_SESSION['course_id'].'/lecture_check'); ?>" method="POST">
								<div class="form-group">
									...
									<?php echo form_error('lecture_title'); ?>
								</div>
								<div class="form-group">
									<textarea class="form-control" name="lecture_body" placeholder="Lecture Body"  rows="4" maxlength=""><?php echo set_value('lecture_body'); ?></textarea>
									<?php echo form_error('lecture_body'); ?>
								</div>
								<div class="form-group">
