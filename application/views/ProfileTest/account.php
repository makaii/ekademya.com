...
<div class="container mt-5">    
  <div class="row">
    <div class="col-sm-2 well">
      ...
      <a href="account.php" class="list-group-item list-group-item-action active">Account</a>
          ...
          <form>
            <div class="form-group">
               <div class="well">
                  ...
                  <input class="form-control form-control-sm" type="text" maxlength="25" placeholder="Enter Current Password" name="website"></input>
                  <br>
                  <input class="form-control form-control-sm" type="text" maxlength="25" placeholder="Enter New Password" name="website"></input>
                  <br>
                  <input class="form-control form-control-sm" type="text" maxlength="25" placeholder="Re-Type Password" name="website"></input>
                </div>
            </div>
          </form> 
