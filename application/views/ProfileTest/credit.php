...
<div class="container mt-5">    
  <div class="row">
    <div class="col-sm-2 well">
      ...
      <a href="credit.php" class="list-group-item list-group-item-action active">Credit Cards</a>
      ...
      <div class="well">
        <form>
                <div class="form-group">
                  <p style="text-align: left;">Payment Settings:</p>
                  <div class="well">
                    <input type="checkbox" name="transac"> Use my transaction for further purchase.
                  </div>
                </div>
              </form> 
          </div>
