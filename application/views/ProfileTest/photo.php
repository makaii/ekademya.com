...
<div class="container mt-5">    
  <div class="row">
    <div class="col-sm-2 well">
      ...
      <a href="photo.php" class="list-group-item list-group-item-actio active">Photo</a>
    ...
    <div class="col-sm-6 well text-center" >
          ...
          <p>Add a nice photo of yourself for your profile</p>
              <div class="well text-center" >
              <img src="image/boyProf.jpg" class="img-rectangle" height="65" width="65" alt="Avatar">
              <br>
