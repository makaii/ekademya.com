...
<div class="container mt-5">    
  <div class="row">
    <div class="col-sm-2 well">
      ...
      <a href="danger.php" class="list-group-item list-group-item-action active">Danger Zone</a>
    </div>
  </div>
    <div class="col-sm-6 well text-center" >
      ...
      <div class="well">
        ...
        <p>Warning:</p>
        <p>If you delete your account, you will be unsubcribed to all of your courses and will lose access. </p>
