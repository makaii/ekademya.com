...
<div class="container mt-5">    
  <div class="row">
    <div class="col-sm-2 well">
      ...
      <a href="notif.php" class="list-group-item list-group-item-action active">Notifications</a>
    ...
    <div class="col-sm-6 well text-center" >
          ...
          <p>Turn on or off promotional email notification</p>
      <div class="well">
        <form>
                <div class="form-group ">
                  <p style="text-align: left;">I want to receive:</p>
                    <input type="checkbox" name="transac"> Promotions, course recommendations and helpful resources
                    <br>
                    <input type="checkbox" name="transac"> Announcements from instructors whose course(s) I'm enrolled in.
                    <br>
                    <input type="checkbox" name="transac"> Don't send any promotional email.
                </div>
              </form> 
          </div>
