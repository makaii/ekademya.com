...
<div class="container mt-5">    
  <div class="row">
    <div class="col-sm-2 well">
      ...
      <a href="privacy.php" class="list-group-item list-group-item-action active">Privacy</a>
    ...
    <div class="col-sm-6 well text-center" >
          ...
          <p>Modify privacy settings</p>
      <div class="well">
        <form>
                <div class="form-group ">
                  <p style="text-align: left;">Profile Page Settings:</p>
                    <input type="checkbox" name="transac"> Show my profile on search engines.
                    <br>
                    <input type="checkbox" name="transac"> Show courses I am taking on my profile page.
                </div>
              </form> 
          </div>
